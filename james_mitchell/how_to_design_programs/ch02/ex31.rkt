...
(write-file "in-fst.txt" "James")
(write-file "in-lst.txt" "Mitchell")
(write-file "in-signature.txt" "Lottery Commission")
...
:ch02 jmitchell$ cat output.txt
Dear James,

We have discovered that all people with the
last name Mitchell have won our lottery. So, 
