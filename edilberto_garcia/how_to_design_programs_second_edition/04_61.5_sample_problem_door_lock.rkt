...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname 04_61.5_sample_problem_door_lock) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
; Sample Problem Design a world program that simulates the working of
;    a door with an automatic door closer. If this kind of door is locked,
;    you can unlock it with a key. An unlocked door is closed, but someone
;    pushing at the door opens it. Once the person has passed through the door
;    and lets go, the automatic door takes over and closes the door again. When
;    a door is closed, it can be locked again.
