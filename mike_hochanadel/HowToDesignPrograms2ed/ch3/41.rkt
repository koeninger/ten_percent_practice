...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname |41|) (read-case-sensitive #t) (teachpacks ((lib "image.rkt" "teachpack" "2htdp") (lib "universe.rkt" "teachpack" "2htdp") (lib "batch-io.rkt" "teachpack" "2htdp"))) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ((lib "image.rkt" "teachpack" "2htdp") (lib "universe.rkt" "teachpack" "2htdp") (lib "batch-io.rkt" "teachpack" "2htdp")) #f)))
; Car measurements
; Wheel size
...
; Vertical position of car
(define Y-CAR
  (+ (* WHEEL-RADIUS 2) (* BODY-HEIGHT 2)))

; Background detail
(define BACKGROUND
  (empty-scene (* WHEEL-RADIUS 50) (+ Y-CAR (* WHEEL-RADIUS 2))))
