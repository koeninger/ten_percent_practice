...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname |100|) (read-case-sensitive #t) (teachpacks ((lib "image.rkt" "teachpack" "2htdp") (lib "universe.rkt" "teachpack" "2htdp") (lib "batch-io.rkt" "teachpack" "2htdp"))) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ((lib "image.rkt" "teachpack" "2htdp") (lib "universe.rkt" "teachpack" "2htdp") (lib "batch-io.rkt" "teachpack" "2htdp")) #f)))
...
(check-expect (si-control (make-aim (make-posn 34 43) (make-tank 54 -10)) "left")
              (make-aim (make-posn 34 43) (make-tank 54 (make-negative -10))))
(check-expect (si-control (make-aim (make-posn 34 43) (make-tank 54 10)) "left")
              (make-aim (make-posn 34 43) (make-tank 54 (make-negative -10))))
...
(define (si-main u-x t-x)
  (big-bang (make-aim (make-posn u-x 0) (make-tank t-x TANK_SPEED))
    [on-tick si-move]
    [to-draw si-render]
    [on-key si-control]
