...
; interpretation (make-phone# area switch num) means a pone# of
; area areacode with range 100-999
; switch first 3 numbers of phone number range 100-999
; num left padded 4 digit number