...
(define (edit ed ke)
  (cond
    ...
    [(and (string=? "\b" ke) (> (string-length (editor-pre ed)) 0)) (make-editor
                         (string-remove-last (editor-pre ed))
                         (editor-post ed))]
    
    [(and (= (string-length ke) 1) (< (image-width (txtRender (make-editor (string-add (editor-pre ed) ke) (editor-post ed) ))) 200)) (make-editor (string-add (editor-pre ed) ke) (editor-post ed) )]
    [(and (string=? "left" ke) (> (string-length (editor-pre ed)) 0))  (make-editor
                           (string-remove-last (editor-pre ed))
                           (string-append (string-last (editor-pre ed)) (editor-post ed)))]
    [(and (string=? "right" ke) (> (string-length (editor-post ed)) 0)) (make-editor
